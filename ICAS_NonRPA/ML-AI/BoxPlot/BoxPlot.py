...
class BoxPlot(Bot):
    ...
    def execute(self, executionContext):
        try:
            ...
            sns.catplot(x=x_axis,y=y_axis ,data=data ,kind="box")
            ...
            plt.savefig(outputfile_path+"Boxplot_png",dpi=200,orientation='landscape')
...
if __name__ == "__main__":
    ...
    # context = {'csv_path':'D:\\Bot_Factory\\usecases\\sheetBoxplotandCountPlot.csv', "x_axis":"time","y_axis":"total_bill", 
    #             "Title":"Box Plot",
