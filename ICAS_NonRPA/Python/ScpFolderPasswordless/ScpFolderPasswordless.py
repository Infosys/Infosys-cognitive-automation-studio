...
#class for bot
class ScpFolderPasswordless(Bot):
    ...
    def execute(self,executionContext):
        try:
            ...
            sourceFolderName=executionContext['sourceFolderName']
            ...
            stdin,stdout,stderr=ssh.exec_command(f"scp -r {sourceFolderName} {remoteUsername}@{destinationHost}:{destinationFolder}")
