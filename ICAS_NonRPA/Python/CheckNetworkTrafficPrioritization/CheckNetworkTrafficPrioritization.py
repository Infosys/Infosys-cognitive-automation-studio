...
class CheckNetworkTrafficPrioritization(Bot):
    ...
    def execute(self,executionContext):
        ...
        try:
            ...
            if executionContext['userName'] != 'NA':
                td_out = remote_connection.read_until(b": ")
                remote_connection.write((str(executionContext['userName'])+"\n").encode('ascii'))
                td_out = remote_connection.read_until(b": ")
                remote_connection.write((str(executionContext['passWord'])+"\n").encode('ascii'))
...
if __name__=="__main__":
    context={}
    bot_obj=CheckNetworkTrafficPrioritization()
