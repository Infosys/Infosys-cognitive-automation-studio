...
class RevokeAccessOfUser(Bot):
    ...
    def execute(self,executionContext):
        try:
            ...
            stdin,stdout,stderr=ssh.exec_command('sudo userdel -r {}'.format(serviceAccountName))
            outlines=stdout.readlines()
            Output=''.join(outlines)+'User deleted Successfully'
            ssh.close()
