...
class GrantAccessToServer(Bot):
    ...
    def execute(self,executionContext):
        try:
            ...
            stdin,stdout,stderr=ssh.exec_command('sudo usermod -a -G wheel {}'.format(serviceAccountName))
            outlines=stdout.readlines()
            Output=''.join(outlines)+'Added Successfully to the Wheel Group'
            ssh.close()
