...
class CreateServiceId(Bot):
    ...
    def execute(self,executionContext):
        try:
            ...
            stdin,stdout,stderr=ssh.exec_command('sudo useradd {}'.format(serviceIdName))
            outlines=stdout.readlines()
            Output=''.join(outlines)+'Service ID Created Successfully'
            ssh.close()
