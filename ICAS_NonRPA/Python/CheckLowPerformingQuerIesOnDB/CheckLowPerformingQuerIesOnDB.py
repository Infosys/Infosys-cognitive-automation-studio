...
class CheckLowPerformingQuerIesOnDB(Bot):
...
if __name__ == "__main__":
    context = {}
    bot_obj = CheckLowPerformingQuerIesOnDB()
    #variable to be passed as parameter
    context = {'ipAddress':'','userName':'','password':'','remoteFolder':'','remoteFileName':'mysql-slow.log','logOutputFile': ''}
