 ...
 */
public class RunDotNetApp  {
 
	private static final Logger log = LoggerFactory.getLogger(RunDotNetApp.class);
  ...
  public Status execute(
			...
			@InputParameter(name = "Configuration") Properties conf
			  ...
			  try {
				ExecuteApp(conf,appName,appVersion,dbTechnology);
	...
	private void ExecuteApp(Properties conf, String appName, String appVersion, String dbTechnology) {
		String command;
