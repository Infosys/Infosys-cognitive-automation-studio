...
public class FTPFolderUpload {

	private static final Logger log = LoggerFactory.getLogger(FTPFolderUpload.class);
	@Errors(exceptions= {
	...
	public Status execute(
			...
			@InputParameter(name="ToUploadFolderFrom", constraints= {FOLDER, EXISTS}) String folderFrom,
