...
@Bot(name = "CheckFolderExistsOnWindows", version = "1.0", description = "", botCategory = "String", author = "", technology = "", technologyCode = "01", botCategoryCode = "01", botId = "07")
...
public class CheckFolderExistsOnWindows {
	private static final Logger log = LoggerFactory.getLogger(CheckFolderExistsOnWindows.class);
	...
	public Status execute(
		...
		log.info("Check Folder Details...." + target);
