...
public class FTPFolderMove  {

	private static final Logger log = LoggerFactory.getLogger(FTPFolderMove.class);
	@Errors(exceptions= {
	...
	public Status execute(
			...
			@InputParameter(name="ToMoveFolderFrom", constraints= {FOLDER, EXISTS}) String folderFrom,
...
//			@OutputParameter(name="Files") ObjectHolder<List<String>> files	
		...
		try {
			...
			deleteFolder(new File(folderFrom));
			ftpClient.logout();
